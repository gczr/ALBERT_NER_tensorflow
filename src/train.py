...
flags.DEFINE_string("train_file",   os.path.join("%s/data" % project_dir, "ner.train"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join("%s/data" % project_dir, "ner.dev"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join("%s/data" % project_dir, "ner.test"),   "Path for test data")
