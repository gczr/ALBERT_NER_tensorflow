...
flags.DEFINE_string("train_file",   os.path.join("%s/data/back" % project_dir, "time.train"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join("%s/data/back" % project_dir, "time.dev"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join("%s/data/back" % project_dir, "time.test"),   "Path for test data")
